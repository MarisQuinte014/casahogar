    ...
    <main>
        <div class="container">
            <div class="row row-cols-1 row-cols-md-5 g-4">
                ...
                <!-- card -->
                <div class="card">
                    <img src="<?= $animal["foto"]?>" class="card-img-top imagenes1">
                    <div class="card-body">
                        <h5 class="card-title text-center fuente2"><?= $animal["nombre"]?></h5>
                        <p class="card-text fuente">Edad: <?= $animal["edad"]?></p>
                        <p class="card-text fuente">Descripción: <?= $animal["descripcion"]?></p>
                        <div class="text-center">
                            <button href="#" data-bs-toggle="modal" data-bs-target="#ModalDelete<?= $animal["idAnimal"] ?>"
                            class="btn btn-danger"><i class="fas fa-trash-alt"></i></button>
                            <button href="#" data-bs-toggle="modal" data-bs-target="#ModalEdit<?= $animal["idAnimal"] ?>"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                <form action="<?= site_url('/Animales/editar'.$animal["idAnimal"])?>"
                                                    method="POST">
                                                    <div class="mb-3">
                                                        <label class="form-label fuente"><i
                                                                class="fas fa-bone"></i><b>Animal:</b></label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label fuente"><i
                                                                class="fas fa-dollar-sign"></i><b> Edad:</b></label>
                                                        <input type="number" class="form-control fuente" id="edad"
                                                            name="edad" value="<?= $animal["edad"] ?>">
                                                    </div>
