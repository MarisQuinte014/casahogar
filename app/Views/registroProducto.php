            ...
            <div class="row">
                ...
                <div class="col-6 pt-5 pb-5">
                    <form action="<?= site_url('/RegistroProducto/registrar') ?>" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label fuente"><i class="fas fa-bone"></i><b>
                                    Producto:</b></label>
                            <input type="text" class="form-control fuente" id="producto" name="producto"
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label fuente"><i
                                    class="fas fa-dollar-sign"></i><b> Precio Unidad:</b></label>
                            <input type="number" class="form-control fuente" id="precioUnidad" name="precioUnidad">
                        </div>
                        <div class="mb-3">
                            <!-- <label for="exampleFormControlTextarea1">Descripción:</label> -->
                            <textarea class="form-control fuente" id="descripcion" name="descripcion" rows="3"
                        ...
                        <div class="text-center mt-5 d-grid gap-2">
                            <button type="submit" class="btn btn-primary fuente"><i class="fas fa-vote-yea"></i><b>
                                    Enviar</b></button>
                        </div>
                    </form>
                </div>
        ...
        <div class="container mt-5 pt-4">
            <div class="row">
                <div class="col-4">
                    ...
                    <p class="fuente">Lunes a viernes 7:00 am - 3:00 pm / Sábado: 7:00 am - 2:30 pm / Domingos y
                        festivos 8:00 am - 3:00 pm</p><br>
