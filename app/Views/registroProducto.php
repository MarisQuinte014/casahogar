        ...
        <div class="container">
            <div class="row">
                <div class="col-12 pt-5">
                    <h1 class="text-center fuente2">Registro de Productos</h1>
                </div>
                <div class="col-6 pt-5 pb-5">
                    <form action="<?= site_url('/RegistroProducto/registrar') ?>" method="POST">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label fuente">Producto:</label>
                            <input type="text" class="form-control" id="producto" name="producto" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label fuente">Fotografia:</label>
                            <input type="text" class="form-control" id="fotografia" name="fotografia">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label fuente">Precio Unidad:</label>
                        ...
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label fuente">Tipo de Animal:</label>
